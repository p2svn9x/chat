<div id="additem">
    ...
    <div class="form-group">
        ...
        <select class="form-control input_add_item" id="typeCategory" onchange="typeCategory()">
    ...
    <div class="form-group" id="groupLink">
        ...
        <input type="text" class="form-control input_add_item" id="customLink" placeholder="Icom">
    </div>
    <div class="form-group" id="groupLink">
    ...
    <input type="hidden" class="form-control input_add_item" id="id" value="0"/>
    <button type="button" class="btn btn-primary" id="add_item1" onclick="saveCategory()">Lưu lại</button>
