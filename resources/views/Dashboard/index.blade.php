...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('/') }}css/dashboard/webClient.css"/>
    <link rel="stylesheet" href="{{ URL::asset('/') }}css/dashboard/common.css"/>
    <link rel="stylesheet" href="{{ URL::asset('/') }}css/dashboard/swx.css"/>
    <link rel="stylesheet" href="{{ URL::asset('/') }}css/dashboard/style.css"/>
</head>

<body class="swx desktop" tabindex="-1">
<div class="shell notifications" id="notifications" aria-live="polite" aria-atomic="true"></div>
            ...
            <div class="Me">
                <div class="Me-small">
                    ...
                    <div id="expandMeProfileLabel" class="offScreen">
                        <span data-bind="text: displayNameUnescaped">Mr.Duy</span>
                        ...
                        <div class="Me-info">
                                <span class="Me-displayNameContainer">
									<p aria-labelledby="expandMeProfileLabel" class="Me-displayName fontSize-h3 strong"
                                       role="button" tabindex="0">Mr.Duy</p>
								</span>
                                            ...
                                            <div class="grid">
                                                ...
                                                <span class="tileText">
                                                    <span class="tileName square">
                                                        <h3>
                                                            <span role="button"
                                                                  class="iconfont button chevronUp hide"></span>
                                                    ...
                                                    <span class="tileMessage presence circle">
                                                        <div class="message fixSmall">
                                                            <div class="displayMessage" style="max-height: 100px;overflow: hidden;">
                                                                <span class="iconfont groupParticipantsLabel fontSize-p"
                                                                      title="dưqdưq"> noi dung tieu de</span>
                                                            </div>
                                                        </div>
                                                    </span>
                                                </span>
                                                ...
                                                <div class="headerControls newConversationV2">
                                                    <div class="buttonRow">
                                                        <swx-button class="callButtons">
                                                            <button type="button"
                                                                    class="btn disabled swx-video-call-btn primary circle">
                                                                <span data-bind="css: spanCssClass, text: text"
                                                                      class="iconfont videoOn">Video Call</span>

                                                            </button>
                                                        </swx-button>
                                                        <swx-button class="callButtons">
                                                            <button type="button"
                                                                    class="btn swx-audio-call-btn primary circle">
                                                                <span data-bind="css: spanCssClass, text: text"
                                                                      class="iconfont callStart">Audio Call</span>

                                                            </button>
                                                        </swx-button>
                                                        <swx-button data-swx-testid="addParticipantAction">
                                                            <button type="button" role="button"
                                                                    class="btn secondary circle stroke">
